<x-guest-layout title="Register">
    <form method="POST" action="{{ route('register') }}" x-data="{ isSubmitting: false }" @submit="isSubmitting = true">
        ...
        <div class="flex items-center justify-end mt-4 gap-3">
            ...
            <x-primary-button id="submit-btn" disabled class="bg-theme-primary hover:bg-theme-hover text-white opacity-60 cursor-not-allowed transition-all duration-300 shadow-md flex justify-center min-w-[120px]">
