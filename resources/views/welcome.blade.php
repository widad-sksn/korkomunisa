...
@section('content')
    ...
    <div class="relative py-8 md:py-12 text-center transition-colors duration-300 overflow-hidden flex flex-col items-center justify-center min-h-[35vh] bg-theme-bg">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center relative z-10">
            ...
            <p class="text-lg md:text-2xl italic font-light mb-10 -mt-4 md:-mt-8 text-theme-secondary drop-shadow-sm leading-relaxed relative z-20">
