                                    ...
                                    @foreach($pendingArticles as $article)
                                        <tr class="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                                            ...
                                            <td class="py-3 px-4 flex flex-wrap gap-2 items-center">
                                                <a href="{{ route('articles.show_public', $article) }}" target="_blank" class="px-2 py-1 bg-blue-500 text-white text-xs rounded hover:bg-blue-600 font-medium">Baca Detail</a>
