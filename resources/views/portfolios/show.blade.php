...
<head>
    ...
    <!-- SEO Meta Tags -->
    @php
        $metaDescription = Str::limit(html_entity_decode(strip_tags($portfolio->description)), 150);
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @if($portfolio->url)
                <div class="mt-8 text-center md:text-left">
                    <a href="{{ $portfolio->url }}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center px-6 py-3 bg-theme-primary text-white rounded-full font-bold text-sm hover:bg-theme-hover transition-colors shadow-md">
