                                        ...
                                        <tr class="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                                            ...
                                            <td class="py-3 px-4">
                                                <div class="flex flex-wrap gap-2 justify-end items-center">
                                                    ...
                                                    <form id="delete-form-article-{{ $article->id }}" action="{{ route('articles.destroy', $article) }}" method="POST" class="inline-block m-0">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="button" onclick="confirmDelete('delete-form-article-{{ $article->id }}', 'Yakin ingin menghapus tulisan ini?')" class="px-3 py-1.5 bg-red-500 text-white text-xs rounded-md hover:bg-red-600 font-medium whitespace-nowrap">Hapus</button>
                                                    </form>
                                                </div>
                                            </td>
                                        </tr>
