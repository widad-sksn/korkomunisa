...
<head>
    ...
    <meta name="keywords" content="IMM, Ikatan Mahasiswa Muhammadiyah, Korkom UNISA, {{ $article->title }}">
    
    <!-- Open Graph / Social Media -->
    <meta property="og:type" content="article">
    <meta property="og:url" content="{{ url()->current() }}">
    <meta property="og:title" content="{{ $article->title }} - IMM KORKOM UNISA">
    ...
    <meta name="twitter:title" content="{{ $article->title }} - IMM KORKOM UNISA">
                ...
                <div class="flex items-center justify-center space-x-4 text-theme-secondary text-sm font-medium">
                    <span class="flex flex-col sm:flex-row items-center">
                        <span class="flex items-center">
                            ...
                            {{ __('Oleh:') }} <span class="font-bold ml-1">{{ optional($article->user)->name ?? __('Anonim') }}</span>
                        </span>
                        @if($article->user)
