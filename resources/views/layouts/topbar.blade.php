    ...
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16 -mb-px">
            ...
            <div class="flex">
                ...
                <button class="text-theme-secondary hover:text-theme-primary lg:hidden" @click="sidebarOpen = !sidebarOpen" aria-controls="sidebar" :aria-expanded="sidebarOpen">
            ...
            <div class="flex items-center space-x-3">
                ...
                <!-- Theme Toggle -->
                <button @click="toggleTheme()" class="text-theme-secondary hover:text-theme-primary focus:outline-none p-2 rounded-full hover:bg-theme-bg transition-colors">
