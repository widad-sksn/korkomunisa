...
class GeminiTranslationService
{
    ...
    public static function translate(array $data): ?array
    {
        ...
        $systemInstruction = "You are a professional translator. Supported languages are: Indonesian (id), English (en), Arabic (ar), Japanese (ja), and Javanese (jv) (Use formal Krama Javanese).\n"
            ...
            . "5. CRITICAL: If the source text contains a mix of Indonesian and Arabic (such as Quranic verses or Hadith), DO NOT translate the Arabic text. Preserve the Arabic verses exactly as they are in all translations, and only translate the Indonesian parts.\n"
            . "6. Return JSON only, without markdown code blocks, using this exact format:\n"
            . "{\n"
